"""
Django settings for chatllm project.
...
SECRET_KEY = 'django-insecure-*-sspvt6ctmg7*6v%-)%5i$7%=-_1vl9ap=v^ph$=%r&!u+h$x'
...
WSGI_APPLICATION = 'chatllm.wsgi.application'
